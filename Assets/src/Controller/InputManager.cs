...
namespace FunnyPoker.src.Controller
{
    public class InputManager : MonoBehaviour
    {
        ...
        private InputField _inputBid;
        private Button _btnBid;
        private bool _isButtonClicked;
        private GameObject _gameObjectTextInvalid;
        ...
        private void Start()
        {
            ...
            _btnBid = GameObject.Find("btnEnterBid").GetComponent<Button>();
        ...
        public IEnumerator OpenInputWindowAndProcessInputData(StringBuilder input)
        {
            ...
            if (_panel.activeSelf == false)
            {
                ...
                if(_gameObjectTextInvalid.activeSelf == true)
                {
                    _gameObjectTextInvalid.SetActive(false);
                    _gameObjTextBid.SetActive(true);
                }
            }
            ...
            input.Clear();
            input.Append(_inputBid.text);

            if(!IsProperCardsFigure(input))
            {
                _gameObjTextBid.SetActive(false);
                _gameObjectTextInvalid.SetActive(true);
